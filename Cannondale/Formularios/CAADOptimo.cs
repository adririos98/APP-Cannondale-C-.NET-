...
{
    public partial class ComboBoxHorquillaEquipos : Template
    {
        ...
        public ComboBoxHorquillaEquipos()
        {
            InitializeComponent();
        }
        //Metodo encargado de cargar todos los datos de la página especializada para CAAD Optimo con los datos recogidos de la bbdd (Cuadros)
        public void Cargar_Datos_Cuadro()
        {
            conexion.Open();
            SqlCommand comandos = new SqlCommand("SELECT Id_Cuadro,Tipo_Cuadro,Precio_Cuadro FROM Cuadros WHERE Modelo_Bicicleta='CAADOptimo'", conexion);
        ...
        private void CAADOptimo_Load(object sender, EventArgs e)
        {
            Cargar_Datos_Cuadro();
            Cargar_Datos_Color();
        ...
        private void ComboBoxCuadro_SelectedIndexChanged(object sender, EventArgs e)
        {
                ...
                if (ComboBoxCuadro.Text == "100A Acero")
                {
                    //Parte de la imagen del cuadro (PictureBox)
                    PictureBoxCuadro.Image = Image.FromFile(RutaFotos + "cuadro.jpg"); 

                    SqlCommand cmd = new SqlCommand();
                    conexion.Open();
                    cmd.Connection = conexion;
                    cmd.CommandText = "SELECT Precio_Cuadro FROM Cuadros WHERE Tipo_Cuadro='100A Acero'";
                    SqlDataReader DataReader = cmd.ExecuteReader();
                    string getdato;
                    while (DataReader.Read())
                    {
                ...
                if (ComboBoxCuadro.Text == "100A Aluminio")
                {
                    //Parte de la imagen del cuadro (PictureBox)
                    PictureBoxCuadro.Image = Image.FromFile(RutaFotos + "cuadro.jpg");
                    SqlCommand cmd = new SqlCommand();
                    conexion.Open();
                    cmd.Connection = conexion;
                    cmd.CommandText = "SELECT Precio_Cuadro FROM Cuadros WHERE Tipo_Cuadro='100A Aluminio'";
                    SqlDataReader DataReader = cmd.ExecuteReader();
                    string getdato;
                    while (DataReader.Read())
                    {
                ...
                if (ComboBoxCuadro.Text == "100C Carbono")
                {
                    //Parte de la imagen del cuadro (PictureBox)
                    PictureBoxCuadro.Image = Image.FromFile(RutaFotos + "cuadro.jpg");
                    SqlCommand cmd = new SqlCommand();
                    conexion.Open();
                    cmd.Connection = conexion;
                    cmd.CommandText = "SELECT Precio_Cuadro FROM Cuadros WHERE Tipo_Cuadro='100C Carbono'";
                    SqlDataReader DataReader = cmd.ExecuteReader();
                    string getdato;
                    while (DataReader.Read())
                    {
                ...
                if (ComboBoxCuadro.Text == "200C Carbono Plus")
                {
                    //Parte de la imagen del cuadro (PictureBox)
                    PictureBoxCuadro.Image = Image.FromFile(RutaFotos + "cuadro.jpg");
                    SqlCommand cmd = new SqlCommand();
                    conexion.Open();
                    cmd.Connection = conexion;
                    cmd.CommandText = "SELECT Precio_Cuadro FROM Cuadros WHERE Tipo_Cuadro='200C Carbono Plus'";
                    SqlDataReader DataReader = cmd.ExecuteReader();
                    string getdato;
                    while (DataReader.Read())
                    {
                ...
                if (ComboBoxCuadro.Text == "100T Titanio")
                {
                    //Parte de la imagen del cuadro (PictureBox)
                    PictureBoxCuadro.Image = Image.FromFile(RutaFotos + "cuadro.jpg");
                    SqlCommand cmd = new SqlCommand();
                    conexion.Open();
                    cmd.Connection = conexion;
                    cmd.CommandText = "SELECT Precio_Cuadro FROM Cuadros WHERE Tipo_Cuadro='100T Titanio'";
                    SqlDataReader DataReader = cmd.ExecuteReader();
                    string getdato;
                    while (DataReader.Read())
                    {
                ...
                if (ComboBoxCuadro.Text == "200T Titanio Plus")
                {
                    //Parte de la imagen del cuadro (PictureBox)
                    PictureBoxCuadro.Image = Image.FromFile(RutaFotos + "cuadro.jpg");
                    SqlCommand cmd = new SqlCommand();
                    conexion.Open();
                    cmd.Connection = conexion;
                    cmd.CommandText = "SELECT Precio_Cuadro FROM Cuadros WHERE Tipo_Cuadro='200T Titanio Plus'";
                    SqlDataReader DataReader = cmd.ExecuteReader();
                    string getdato;
        ...
        private void ComboBoxColor_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ComboBoxColor.Text == "Apilne")
            {
                ...
                PictureBoxBicicleta.Image = Image.FromFile(RutaFotos + "CAADOptimo_alpine.PNG");
                SqlCommand cmd = new SqlCommand();
                conexion.Open();
                cmd.Connection = conexion;
            ...
            if (ComboBoxColor.Text == "Blanco")
            {
                ...
                PictureBoxBicicleta.Image = Image.FromFile(RutaFotos + "CAADOptimo_Blanco.PNG");
                SqlCommand cmd = new SqlCommand();
                conexion.Open();
                cmd.Connection = conexion;
            ...
            if (ComboBoxColor.Text == "Gris")
            {
                ...
                PictureBoxBicicleta.Image = Image.FromFile(RutaFotos + "CAADOptimo_gray.PNG");
                SqlCommand cmd = new SqlCommand();
                conexion.Open();
                cmd.Connection = conexion;
            ...
            if (ComboBoxColor.Text == "Rojo")
            {
                ...
                PictureBoxBicicleta.Image = Image.FromFile(RutaFotos + "CAADOptimo_rojo.PNG");
                SqlCommand cmd = new SqlCommand();
                conexion.Open();
                cmd.Connection = conexion;
            ...
            if (ComboBoxColor.Text == "Negro")
            {
                ...
                PictureBoxBicicleta.Image = Image.FromFile(RutaFotos + "CAADOptimo_negro.PNG");
                SqlCommand cmd = new SqlCommand();
                conexion.Open();
                cmd.Connection = conexion;
        ...
        private void BotonTerminar_Click_1(object sender, EventArgs e)
        {
            try
            {
        ...
        private void LabelPrecioColor_Click(object sender, EventArgs e)
        {

        }

        private void LabelCuadro_Click(object sender, EventArgs e)
        {
